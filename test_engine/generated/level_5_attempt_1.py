...
# If agent_b date_count < 5: total = (0.50/(0.50+0.20))*cap + (0.20/(0.50+0.20))*style, trust_used=0.0.
# Else: total = 0.50*cap + 0.20*style + 0.30*agent_b['trust'], trust_used = agent_b['trust'].
# Return float.
...
def compute_compatibility_score(agent_a, agent_b):
    ...
    if date_count < 5:
        cap_w = 0.50 / (0.50 + 0.20)
        style_w = 0.20 / (0.50 + 0.20)
